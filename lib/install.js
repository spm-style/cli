...
let isInProject = (install) => {
  if (install.debug) { console.log('funct° - isInProject') }
...
let alreadyInList = (type, install) => {
  if (install.debug) { console.log('funct° - alreadyInList') }
  switch (type) {
    case 'download':
  ...
  if (install.debug) { console.log(`end of alreadyInList with ${type}, target = ${install.current.target}`) }
  return false
}
...
let loopForInRecursivePromise = (install, table, index = 0, promises = []) => {
  return new Promise((resolve, reject) => {
    if (install.debug) { console.log('funct° - loopForInRecursivePromise', table, index) }
...
let loopForInPromise = (install) => {
  return new Promise((resolve, reject) => {
    if (install.debug) { console.log('funct° - loopForInPromise') }
