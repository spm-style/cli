...
let userDirectory = process.env[(process.platform === 'win32') ? 'USERPROFILE' : 'HOME']
...
module.exports = {
  ...
  SPM_USER_DIRECTORY: `${userDirectory}${separator}.spm`,
  REGISTRY_PATH: `${userDirectory}${separator}.spm${separator}registry`,
  WARNING: {
