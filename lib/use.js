...
let findPackagePromise = (use) => {
  return new Promise((resolve, reject) => {
    if (use.debug) { console.log('> findPackagePromise') }
...
let selectModulePromise = (use) => {
  if (use.debug) console.log('> selectModulePromise')
  return new Promise((resolve, reject) => {
...
let selectClassPromise = (use) => {
  return new Promise((resolve, reject) => {
    if (use.debug) { console.log('> selectClassPromise') }
    let maxLen = 0
    let tmpModules = []
    let tmpClasses = []
    let promises = []
...
let selectInstancePromise = (use) => {
  return new Promise((resolve, reject) => {
    if (use.debug) console.log('> selectInstancePromise')
    let promises = []
    for (let module of use.modules) {
...
let selectTargetFilesPromise = (use) => {
  if (use.debug) console.log('> selectTargetFilesPromise')
  return new Promise((resolve, reject) => {
...
let updateInstanceDependenciesPromise = (use) => {
  if (use.debug) console.log('> updateInstanceDependenciesPromise')
  return new Promise((resolve, reject) => {
    if (!use.isSave) {
      return resolve(use)
    }
