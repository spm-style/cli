...
let findPackagePromise = (generate) => {
  if (generate.debug) { console.log('> findPackagePromise') }
...
let parsePackagePromise = (generate) => {
  if (generate.debug) { console.log('> parsePackagePromise') }
  return new Promise((resolve, reject) => {
    if (!generate.isSave) {
      return resolve(generate)
    }
...
let selectModulePromise = (generate) => {
  if (generate.debug) { console.log('> selectModulePromise') }
  return new Promise((resolve, reject) => {
...
let listAllClassesPromise = (generate, module) => {
  if (generate.debug) { console.log('> listAllClassesPromise') }
  return new Promise((resolve, reject) => {
...
let selectClassPromise = (generate) => {
  if (generate.debug) { console.log('> selectClassPromise') }
  return new Promise((resolve, reject) => {
    if (!generate.classTarget) {
...
let checkInstanceAvailablePromise = (generate) => {
  if (generate.debug) { console.log('> checkInstanceAvailablePromise') }
  return new Promise((resolve, reject) => {
...
let customizeVariablesPromise = (generate) => {
  if (generate.debug) { console.log('> customizeVariablesPromise') }
  return new Promise((resolve, reject) => {
...
let distCreationPromise = (generate) => {
  if (generate.debug) { console.log('> distCreationPromise') }
  return new Promise((resolve, reject) => {
...
let instanceCreationPromise = (generate) => {
  if (generate.debug) { console.log('> instanceCreationPromise') }
  return new Promise((resolve, reject) => {
...
let updateUsedFiles = (generate) => {
  if (generate.debug) { console.log('> updateUsedFiles') }
  return new Promise((resolve, reject) => {
...
let updateInstanceDependenciesPromise = (generate) => {
  if (generate.debug) { console.log('> updateInstanceDependenciesPromise') }
  return new Promise((resolve, reject) => {
