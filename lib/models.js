...
class Publish {
  constructor (moduleName, debug) {
    this.name = moduleName.indexOf('@') > 0 ? moduleName.substring(0, moduleName.indexOf('@')) : moduleName
    this.version = moduleName.indexOf('@') > 0 ? moduleName.substring(moduleName.indexOf('@') + 1) : null
