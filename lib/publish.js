...
let existsPackagePromise = (publication) => {
  if (publication.debug) console.log(' ** stage 1a **')
...
let checkPackagePromise = (jsonFile, publication) => {
  if (publication.debug) console.log('  + stage 1bi +')
  return new Promise((resolve, reject) => {
    if (jsonFile) {
      // style
...
let parsePackagePromise = (publication) => {
  if (publication.debug) console.log(' ** stage 1b **')
  return new Promise((resolve, reject) => {
    if (publication.path) {
...
let verifyPackagePromise = (publication) => {
  if (publication.debug) console.log('--- stage 1 ---')
  return new Promise((resolve, reject) => {
...
let verifyRefDomPromise = (publication) => {
  if (publication.debug) console.log('-- stage 1bis -')
  return new Promise((resolve, reject) => {
...
let verifyModulePromise = (publication) => {
  if (publication.debug) console.log('--- stage 2 ---')
  return new Promise((resolve, reject) => {
...
let confirmationPublishPromise = (publication) => {
  if (publication.debug) console.log('--- stage 3 ---')
  return new Promise((resolve, reject) => {
...
let promptUserPromise = (publication) => {
  if (publication.debug) console.log('--- stage 4 ---')
  return new Promise((resolve, reject) => {
    let questions = [
      {
        name: 'username',
...
let parseIgnoreFiles = (ignoreFiles, publication) => {
  if (publication.debug) console.log('  + stage 5aI +')
  let ignores = []
...
let updateDefaultIgnoreFiles = (ignores, publication) => {
  if (publication.debug) console.log('  + stage 5aJ +')
...
let verifyIgnoredFilesPromise = (publication) => {
  if (publication.debug) console.log(' ** stage 5a **')
  return new Promise((resolve, reject) => {
...
let recursiveCheckModule = (path, file, publication) => {
  if (publication.debug) console.log('  + stage 5bI + recursive')
...
let scssToCssForCheck = (publication) => {
  if (publication.debug) console.log('  + stage 5bJ +')
  return new Promise((resolve, reject) => {
...
let mapDependenciesClassesPromise = (publication) => {
  if (publication.debug) console.log('mapDependenciesClassesPromise')
  return new Promise((resolve, reject) => {
...
let checkModule = (publication) => {
  if (publication.debug) console.log(' ** stage 5b **')
  return new Promise((resolve, reject) => {
...
let recursiveDirectoryCopy = (path, directory, ignores, publication) => {
  if (publication.debug) console.log('  + stage 5cI +', directory)
  return new Promise((resolve, reject) => {
...
let publicationCopyPromise = (publication) => {
  if (publication.debug) console.log(' ** stage 5c **')
  return new Promise((resolve, reject) => {
...
let createTgzPromise = (publication) => {
  if (publication.debug) console.log(' ** stage 5d **')
  return new Promise((resolve, reject) => {
    Fs.mkdir(`${publication.path}/.tmp`, err => {
      if (err && err !== 'EEXIST') { return reject(err) }
...
let cleanUpWorkingDirectory = (publication) => {
  if (publication.debug) console.log(' ** stage 5g ** ')
  return new Promise((resolve, reject) => {
...
let sendPublicationToRegistryPromise = (publication) => {
  if (publication.debug) console.log(' ** stage 5f ** POST TO SPM REGISTRY')
  return new Promise((resolve, reject) => {
...
let publishModulePromise = (publication) => {
  if (publication.debug) console.log('--- stage 5 ---')
  return new Promise((resolve, reject) => {
...
module.exports = (Program) => {
  return new Promise((resolve, reject) => {
    ...
    .arguments('[pkg]')
    .option('-t, --tag <tag>', "your package's version, latest by default")
    ...
    .action((pkg, options) => {
      let publication = new Publish(pkg, options.tag, options.debug)
